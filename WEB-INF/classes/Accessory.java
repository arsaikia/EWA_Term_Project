...
public class Accessory extends HttpServlet {
	...
	private HashSet<String> foundAccessories;
	...
	public Accessory() {
		this.foundAccessories = new HashSet<String>();
	}
	public String getId() {
		return id;
	}
	...
	public boolean getFoundAccessories(String accessoryId) {
		return this.foundAccessories.contains(accessoryId);
	}

	public void setFoundAccessories(String accessoryId) {
		this.foundAccessories.add(accessoryId);
	}
